...
Installing "Voo_Debug" can be done either by searching for "Voo_Debug" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
